...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_error = np.multiply(output_layer_activation_derivative_vec(activated_output),
        ...
        bias_gradients = np.multiply(hidden_layer_error, rectified_linear_unit_derivative_vec(hidden_layer_weighted_input))
